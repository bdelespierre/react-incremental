...
import { GeneratorDict } from "./Generators"
...
export type TechnologyModel = {
  ...
  effect: (generators: GeneratorDict) => void,
  effectMessage: ReactElement,

  isLocked: Boolean,
  unlock?: (technologies: TechnologyDict, generators: GeneratorDict) => boolean,
  lockedMessage?: string,
}

export type TechnologyDict = {
  [key: string]: TechnologyModel,
}

const Technologies: TechnologyDict = {
  'proton-decay-accelerator': {
    ...
    effect: (generators: GeneratorDict) => {
    ...
    effectMessage: <span>All generator <span style={{ color: "green" }}>+5%</span></span>,

    isLocked: true,
    unlock: (technologies: TechnologyDict, generators: GeneratorDict) => generators["entropic-accelerator"].owned >= 2,
